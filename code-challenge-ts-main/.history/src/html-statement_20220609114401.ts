...
export function htmlstatement(baseStatement: typeof statement) {
(params:any, customer: any, movies: any) : string => {
   let splitStatement = baseStatement(customer, movies).split('/n');
